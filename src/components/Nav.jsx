...
const Nav = () => {
  ...
  return (
    ...
    <div className="items-center flex flex-col">
            <a className="my-2 hover:opacity-75 transition-all duration-300" href="/">About Us</a>
            <a className="my-2 hover:opacity-75 transition-all duration-300" href="https://store.getstarterkit.com/policies/privacy-policy">Privacy Policy</a>
            <a className="my-2 hover:opacity-75 transition-all duration-300" href="https://o.getstarterkit.com/design.html">Design Studio</a>
      ...
      <div className="mx-auto flex items-center justify-between h-20 container px-2 lg:px-4 max-w-screen-xl">
        ...
        <div className="items-center mr-1 hidden md:flex">
            <a className="mx-2 lg:mx-4 hover:opacity-75 transition-all duration-300" href="/">About Us</a>
            <a className="mx-2 lg:mx-4 hover:opacity-75 transition-all duration-300" href="https://store.getstarterkit.com/policies/privacy-policy">Privacy Policy</a>
            <a className="mx-2 lg:mx-4 hover:opacity-75 transition-all duration-300" href="https://o.getstarterkit.com/design">Design Studio</a>
